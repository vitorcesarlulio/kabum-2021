                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" name="dateIssueRegister" id="dateIssueRegister" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" value="<?php echo e(date('Y-m-d')); ?>" min="<?php echo e(date('Y-m-d')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" name="dateExpiryRegister" id="dateExpiryRegister" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" value="" min="<?php echo e(date('Y-m-d')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6" id="divPaydayRegister" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="payDayRegister" name="payDayRegister" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" value="<?php echo e(date('Y-m-d')); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6" id="divPaydayUpDate" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="payDayUpDate" name="payDayUpDate" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" value="<?php echo e(date('Y-m-d')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sys-ouse\app\View/finance/accounts-receivable/accounts-receivable.blade.php ENDPATH**/ ?>