            ...
            <form id="formRegisterPeople" method="POST" novalidate="novalidate" autocomplete="off">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="resetInputs('formRegisterPeople');">Cancelar</button>
            ...
            <form id="formEditPeople" method="POST" novalidate="novalidate" autocomplete="off">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-7">
                            <div class="card">
                                <div class="card-header" style="color: #fff;background-color: #0060B1;">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="resetInputs('formEditPeople');">Cancelar</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('templates.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kabum-2021\app\View/people/people.blade.php ENDPATH**/ ?>