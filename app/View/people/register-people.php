...
if (isset($_POST['typePerson']) && !empty($_POST['typePerson'])) {
    ...
    if ($dados['typePerson'] === "F") {
        ...
        $insertPhysicalPerson = $connectionDataBase::connectionDataBase()->prepare($queryInsertPhysicalPerson);
        $typePerson = "F";
        ...
        $insertPhysicalLegal = $connectionDataBase::connectionDataBase()->prepare($queryInsertPhysicalLegal);
        $typePerson = "J";
