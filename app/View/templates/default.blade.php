...
# Periodos do dia para saudar usuário
...
<body class="hold-transition pace-primary pace-done sidebar-mini sidebar-collapse">
  ...
  <div class="wrapper">
      ...
      <div class="sidebar">
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <!-- Somente logins do nível admin tem permissão de visualizar o menu -->
            <?php
            ...
            <li class="nav-item">
              <a href="https://github.com/vitorcesarlulio/kabum-2021/blob/master/README.md" class="nav-link" target="_blank">
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; {{date('Y')}} <a href="https://www.linkedin.com/in/vitor-cesar-lulio/" target="_blank">Vítor César Lulio</a>.</strong>
